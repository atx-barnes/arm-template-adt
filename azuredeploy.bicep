...
// Create Storage container (used for aircraft assets)
...
resource ingestfunction 'Microsoft.Web/sites/extensions@2015-08-01' = {
  ...
  properties: {
packageUri: 'https://github.com/atx-barnes/functions-immersive-adt/raw/main/AzureFunctionsADT/immersiveadt-functions.zip'
dbType: 'None'
    connectionString: ''
  }
  dependsOn: [
